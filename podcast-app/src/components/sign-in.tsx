export default function SignIn(){
    ...
    <form className="max-w-md mx-auto p-6 bg-zinc-700 shadow-md rounded-md bg-zinc-800 border-b-4 border-gradient-to-r">
        ...
        <a href="../home" className="bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text text-center hover:scale-110 text-lg font-bold py-2 px-4 rounded-full border-2">
        Sign in
        </a>
